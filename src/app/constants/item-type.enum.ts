...
export const MainItemWithRelations: Partial<Record<ItemTypeEnum, ItemTypeEnum[]>> = {
  ...
  [ItemTypeEnum.headLower]: [ItemTypeEnum.headLowerCard, ItemTypeEnum.headLowerEnchant1, ItemTypeEnum.headLowerEnchant2, ItemTypeEnum.headLowerEnchant3],

  ...
  updates: { v: string; date: string; logs: string[]; }[] = [
    {
      ...
      logs: [
        ...
        'O passo "ATQ (ajuste de classe)" do Mestre Celestial e do Mestre Estelar passou a mostrar a conta inteira. É nele que o Kihop e a Fúria entram, e duas cifras — antes e depois — não diziam qual das três Fúrias pagou nem sobre o quê. O detalhamento agora lista o ATQ arredondado, o degrau do Kihop e os termos da Fúria que alcança o alvo — (nível base + SOR + DES) ÷ 3, com FOR só na Estelar — e leva à página da habilidade no bROWiki. Qual delas vale é decidido pelo Tamanho do alvo, então o número pode se mover por um atributo que não aparece em nenhuma outra etapa da conta.',

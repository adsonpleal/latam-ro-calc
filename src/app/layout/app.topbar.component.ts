  ...
  updates: { v: string; date: string; logs: string[]; }[] = [
    {
      ...
      logs: [
        ...
        'Oito equipamentos que o cliente acabou de nomear entraram no banco: os visuais Ornamento de Camélias, Asas de Cupido Rosa, Coroa de Flores Vermelhas, Coroa de Mil Rosas, Peruca Longa de Pétalas e Ramo de Cerejeira, e dois adereços de baixo com efeito de verdade — o Amigo Gioia, que reduz pós-conjuração e soma dano mágico de propriedade Fantasma, e o Bebê Lobo, que soma Precisão perfeita e, com a Carta Fofinho, velocidade de ataque e dano contra Chefes.',
      ],
    },
    {
      v: '0.1.67-beta',

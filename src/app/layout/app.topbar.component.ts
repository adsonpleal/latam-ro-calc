  ...
  updates: { v: string; date: string; logs: string[]; }[] = [
    {
      ...
      date: '18-08-2026',
      logs: [
        'O dano por segundo das habilidades de recarga longa saía muito acima do real: no Firmamento, do Mestre Celestial, 122 vezes maior. A cadência de uso era guardada com uma casa decimal só, e uma habilidade que sai uma vez a cada 61 segundos dá 0,016 usos por segundo — arredondado para baixo, zero. Esse zero era lido como "esta habilidade não tem dados de conjuração", e a conta caía na cadência do ataque básico, de dois golpes por segundo, para uma habilidade que sai uma vez por minuto. Agora a cadência guarda precisão suficiente para qualquer recarga. São pelo menos 14 habilidades em 11 classes com recarga de 60 segundos — entre elas o Firmamento, o Omega Abyss Strike, a Revoada Sombria, o Rush Quake e o Elemental Buster —, e as de 3 a 10 segundos também estavam subestimadas, em menor grau. O "Hab./s" dessas habilidades, que aparecia como 0, passou a mostrar a cadência de verdade. O Resumo de Batalha novo já acertava esse número, porque divide dano real por tempo real; quem mostrava os 122 vezes era o resumo antigo. Reportado por Ted.',
        'O aviso "Recarga não fecha" parou de aparecer em rotação de uma habilidade só. Sozinha, a habilidade repete no próprio tempo dela e a espera pela recarga é o ciclo — o Firmamento acusava 59,53 segundos faltando numa rotação perfeitamente normal, e a Centelha das Trevas, 0,75. Do jeito que estava, o aviso saía em vermelho para 244 das 248 habilidades que têm alguma recarga. A linha do tempo também parou de pintar a faixa de vermelho nesse caso. Com duas habilidades ou mais o aviso continua, que é onde ele quer dizer alguma coisa: uma delas realmente segurando a rotação.',
        'A linha do tempo do ciclo passou a espaçar as marcações conforme a duração. Num ciclo de 61 segundos ela desenhava 62 marcações de um segundo, que saíam grudadas como "0s1s2s3s" e davam a impressão de a habilidade estar repetindo dezenas de vezes — as faixas sempre estiveram certas, o eixo é que não estava. Agora o passo cresce junto com o ciclo, de 1 em 1 segundo até de 30 em 30 ou de 60 em 60, mantendo no máximo uma dúzia de marcações. O "Morre em" também deixou de discordar do número ao lado dele: dividia o HP do alvo pelo DPS sustentado, o que espalha uma pancada de 58 milhões pelo minuto inteiro do ciclo e respondia "24,6s" ao lado de "1 uso". Agora percorre a rotação e diz quando cai o golpe que mata.',
        'Cada linha da rotação passou a mostrar os desfechos por trás do número, e não só a média. Uma habilidade que crita parte das vezes mostra a rolagem sem crítico e a com crítico, cada uma com seu mínimo e máximo; uma que nunca crita mostra a rolagem que tem, que antes não aparecia em lugar nenhum. Os três números são coisas diferentes e agora dizem qual é qual: o da linha é a média dos dois desfechos pesada pela taxa de crítico — é ela que a rotação e o DPS usam —, e a etiqueta "média" existe para que a taxa de crítico ao lado não seja aplicada de novo por cima. Clicar em cada um abre a explicação daquele número: as rolagens abrem a fórmula de cada uma, a média abre a conta que mistura as duas. Quando a habilidade tem uma rolagem só, que nunca varia, a linha continua com um número apenas.',
        'Clicar na taxa de crítico passou a abrir a conta inteira, e não só a lista de itens que dão CRIT. A janela mostra cada parcela na ordem em que o jogo aplica: o CRIT que vem do SOR, o dos equipamentos, o valor fixo que a própria habilidade soma — o Tiro Preciso soma 50 —, a parcela do CRIT que a habilidade aproveita, que em algumas é metade, e o escudo de crítico do alvo, que sai do SOR do monstro e era a única parcela que não aparecia em lugar nenhum. Katar dobra o CRIT do personagem e desconta o escudo antes da parcela da habilidade, e a janela segue essa ordem. A lista de itens continua a um clique, na linha "CRIT de equipamentos".',
        'A etapa de redução na fórmula do dano dizia "Redução de aura (99,9%)" mesmo quando quem reduzia era o Aliviar, e mesmo quando o nível do Aliviar tirava bem menos que isso — no nível 5, que corta metade do dano, ela continuava anunciando 99,9%. Agora a etapa diz qual das duas está agindo e traz a porcentagem que ela de fato aplica; com as duas ao mesmo tempo, credita as duas, porque elas se multiplicam.',
        'Habilidades mágicas pararam de exibir "Sem crít." na rotação. Magia não crita, então a frase descrevia o tipo de dano e não a habilidade, e aparecia em toda habilidade mágica do jogo. Numa habilidade física que não crita ela continua, que é onde a ausência diz respeito à habilidade. O cursor de interrogação também saiu de cena: os textos que se explicam ao passar o mouse continuam iguais, com o ponteiro normal.',
      ],
    },
    {
      v: '0.1.65-beta',

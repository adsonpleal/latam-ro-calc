  ...
  updates: { v: string; date: string; logs: string[]; }[] = [
    {
      ...
      logs: [
        ...
        'A Fúria Estelar só somava a FOR contra alvos de tamanho Grande, e a descrição do cliente não condiciona a tamanho nenhum — ela diz que o ATQ melhora "baseado na FOR, SOR, DES e nível base". A parcela da FOR sumia justamente contra os boss de tamanho Médio. Agora a FOR entra sempre, reportado por Luís.',
      ],
    },
    {
      v: '0.1.48-beta',

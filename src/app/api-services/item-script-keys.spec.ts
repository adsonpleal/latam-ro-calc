 ...
 *
 * 6001 (Dragonic Breath) was listed here while the skill was out of the catalog, from
 * 17/08/2026 to 14/09/2026; it is back as a preview skill and its key is modelled again.
 */
...
describe('item.json: combo conditions', () => {
   ...
   */
  const RECORDS_ON_LEGACY_EQUIP = 1447;

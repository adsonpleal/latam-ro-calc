...
export class Mechanic extends Whitesmith {
  ...
  protected readonly atkSkillList3rd: AtkSkillModel[] = [
    ...
    },
    {
      ...
      fct: 0.1,
      vct: 2,
      cd: (lv) => [0.35, 0.3, 0.25, 0.2, 0.15][lv - 1],
      isHDefToSDef: true,
      isIgnoreRes: true,
      isHit100: true,
      totalHit: () => (isDualCannon(this.abrLv) ? 2 : 1),
  ...
  protected readonly passiveSkillList3rd: PassiveSkillModel[] = [
    ...
    },
    {
      ...
      dropdown: [
        { label: '-', value: 0, isUse: false },
        { label: 'Nv 1', value: 1, isUse: true, bonus: { x_atk_element_fire: 10, x_sofDef: 10 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { x_atk_element_fire: 20, x_sofDef: 20 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { x_atk_element_fire: 30, x_sofDef: 30 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { x_atk_element_fire: 40, x_sofDef: 40 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { x_atk_element_fire: 50, x_sofDef: 50 } },
      ],
    },
    {
      label: 'Axe Boomerang',

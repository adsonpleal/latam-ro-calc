  ...
  protected readonly _atkSkillList: AtkSkillModel[] = [
    {
      ...
      levelList: [
        { label: 'Silvervine Stem Spear Nv1 (Earth)', value: 'Silvervine Stem Spear==1' },
        { label: 'Silvervine Stem Spear Nv2 (Fire)', value: 'Silvervine Stem Spear==2' },
        { label: 'Silvervine Stem Spear Nv3 (Wind)', value: 'Silvervine Stem Spear==3' },
        { label: 'Silvervine Stem Spear Nv4 (Water)', value: 'Silvervine Stem Spear==4' },
        { label: 'Silvervine Stem Spear Nv5 (Ghost)', value: 'Silvervine Stem Spear==5' },
      ],
  ...
  protected readonly _activeSkillList: ActiveSkillModel[] = [
    {
      ...
      dropdown: [
        ...
        { label: 'Nv 1', value: 1, isUse: true, bonus: { agi: 20, range: 10 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { agi: 25, range: 10 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { agi: 30, range: 10 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { agi: 35, range: 10 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { agi: 40, range: 10 } },
      ],
    },
    {
  ...
  protected readonly _passiveSkillList: PassiveSkillModel[] = [
    {
      ...
      dropdown: [
        { label: '-', value: 0, isUse: false },
        { label: 'Nv 1', value: 1, isUse: true, bonus: { hp: 1000, sp: 100, healPercent: 10 } },
    ...
    },
    {
      ...
      dropdown: [
        { label: '-', value: 0, isUse: false },
        { label: 'Nv 1', value: 1, isUse: true, bonus: { int: 20 } },
    ...
    },
    {
      ...
      dropdown: [
        { label: '-', value: 0, isUse: false },
        { label: 'Nv 1', value: 1, isUse: true, bonus: { flee: 20, hit: 20, cri: 20 } },

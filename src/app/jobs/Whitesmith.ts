  ...
  protected readonly passiveSkillListHi: PassiveSkillModel[] = [
    HiltBindingFn(),
    {
      ...
      dropdown: [
        ...
        { label: 'Nv 1', value: 1, isUse: true, bonus: { x_resist_fire: 4, x_resist_neutral: 1 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { x_resist_fire: 8, x_resist_neutral: 2 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { x_resist_fire: 12, x_resist_neutral: 3 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { x_resist_fire: 16, x_resist_neutral: 4 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { x_resist_fire: 20, x_resist_neutral: 5 } },
      ],
    },
    {
      ...
      dropdown: [
        { label: '-', value: 0, isUse: false },
        { label: 'Nv 1', value: 1, isUse: true, bonus: { x_atk: 2 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { x_atk: 4 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { x_atk: 6 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { x_atk: 8 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { x_atk: 10 } },
        { label: 'Nv 6', value: 6, isUse: true, bonus: { x_atk: 12 } },
        { label: 'Nv 7', value: 7, isUse: true, bonus: { x_atk: 14 } },
        { label: 'Nv 8', value: 8, isUse: true, bonus: { x_atk: 16 } },
        { label: 'Nv 9', value: 9, isUse: true, bonus: { x_atk: 18 } },
        { label: 'Nv 10', value: 10, isUse: true, bonus: { x_atk: 20 } },
      ],
    },
  ];

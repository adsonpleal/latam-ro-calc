  ...
  protected readonly passiveSkillListHi: PassiveSkillModel[] = [
    {
      ...
      dropdown: [
        ...
        { label: 'Nv 1', isUse: true, value: 1, bonus: { spPercent: 1 * 2 } },
        { label: 'Nv 2', isUse: true, value: 2, bonus: { spPercent: 2 * 2 } },
        { label: 'Nv 3', isUse: true, value: 3, bonus: { spPercent: 3 * 2 } },
        { label: 'Nv 4', isUse: true, value: 4, bonus: { spPercent: 4 * 2 } },
        { label: 'Nv 5', isUse: true, value: 5, bonus: { spPercent: 5 * 2 } },
        { label: 'Nv 6', isUse: true, value: 6, bonus: { spPercent: 6 * 2 } },
        { label: 'Nv 7', isUse: true, value: 7, bonus: { spPercent: 7 * 2 } },
        { label: 'Nv 8', isUse: true, value: 8, bonus: { spPercent: 8 * 2 } },
        { label: 'Nv 9', isUse: true, value: 9, bonus: { spPercent: 9 * 2 } },
        { label: 'Nv 10', isUse: true, value: 10, bonus: { spPercent: 10 * 2 } },
      ],
    },
    {
      label: 'Gravitational',

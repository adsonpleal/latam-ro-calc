...
export class Sura extends Champion {
  ...
  private readonly atkSkillList3rd: AtkSkillModel[] = [
    ...
    },
    {
      ...
      hit: 7,
      levelList: [
        { label: 'Hell Gate Nv1', value: 'Hell Gate==1' },
        { label: 'Hell Gate Nv2', value: 'Hell Gate==2' },
        { label: 'Hell Gate Nv3', value: 'Hell Gate==3' },
        { label: 'Hell Gate Nv4', value: 'Hell Gate==4' },
        { label: 'Hell Gate Nv5', value: 'Hell Gate==5' },
        { label: 'Hell Gate Nv6', value: 'Hell Gate==6' },
        { label: 'Hell Gate Nv7', value: 'Hell Gate==7' },
        { label: 'Hell Gate Nv8', value: 'Hell Gate==8' },
        { label: 'Hell Gate Nv9', value: 'Hell Gate==9' },
        { label: 'Hell Gate Nv10', value: 'Hell Gate==10' },
      ],
    ...
    },
    {
      ...
      hit: 7,
      levelList: [
        { label: 'Hell Gate (Combo) Nv1', value: 'Hell Gate (Combo)==1' },
        { label: 'Hell Gate (Combo) Nv2', value: 'Hell Gate (Combo)==2' },
        { label: 'Hell Gate (Combo) Nv3', value: 'Hell Gate (Combo)==3' },
        { label: 'Hell Gate (Combo) Nv4', value: 'Hell Gate (Combo)==4' },
        { label: 'Hell Gate (Combo) Nv5', value: 'Hell Gate (Combo)==5' },
        { label: 'Hell Gate (Combo) Nv6', value: 'Hell Gate (Combo)==6' },
        { label: 'Hell Gate (Combo) Nv7', value: 'Hell Gate (Combo)==7' },
        { label: 'Hell Gate (Combo) Nv8', value: 'Hell Gate (Combo)==8' },
        { label: 'Hell Gate (Combo) Nv9', value: 'Hell Gate (Combo)==9' },
        { label: 'Hell Gate (Combo) Nv10', value: 'Hell Gate (Combo)==10' },
      ],
      currentHpFn: (maxHp) => this.getCurrentHP(maxHp),
      currentSpFn: (maxSp) => this.getCurrentSP(maxSp),
      formula: (input: AtkSkillFormulaInput): number => {
  ...
  private readonly activeSkillList3rd: ActiveSkillModel[] = [
    {
      ...
      dropdown: [
        ...
        { label: 'Nv 1', value: 1, isUse: true, bonus: { hpPercent: 1, spPercent: 1 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { hpPercent: 2, spPercent: 2 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { hpPercent: 3, spPercent: 3 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { hpPercent: 4, spPercent: 4 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { hpPercent: 5, spPercent: 5 } },
        { label: 'Nv 6', value: 6, isUse: true, bonus: { hpPercent: 6, spPercent: 6 } },
        { label: 'Nv 7', value: 7, isUse: true, bonus: { hpPercent: 7, spPercent: 7 } },
        { label: 'Nv 8', value: 8, isUse: true, bonus: { hpPercent: 8, spPercent: 8 } },
        { label: 'Nv 9', value: 9, isUse: true, bonus: { hpPercent: 9, spPercent: 9 } },
        { label: 'Nv 10', value: 10, isUse: true, bonus: { hpPercent: 10, spPercent: 10 } },
      ],
    },
    {
      label: 'GT - Opposite',
    ...
    },
    {
      ...
      dropdown: [
        { label: '-', value: 0, isUse: false },
        { label: 'Nv 1', value: 1, isUse: true, bonus: { hpPercent: 1 * 2, def: 1 * 20, 'Tiger Cannon': 30 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { hpPercent: 2 * 2, def: 2 * 20, 'Tiger Cannon': 30 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { hpPercent: 3 * 2, def: 3 * 20, 'Tiger Cannon': 30 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { hpPercent: 4 * 2, def: 4 * 20, 'Tiger Cannon': 30 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { hpPercent: 5 * 2, def: 5 * 20, 'Tiger Cannon': 30 } },
      ],
    },
    {
      label: 'Earth Shaker',
  ...
  private readonly passiveSkillList3rd: PassiveSkillModel[] = [
    ...
    },
    {
      ...
      dropdown: [
        { label: '-', value: 0, isUse: false },
        { label: 'Nv 1', value: 1, isUse: true, bonus: { x_fist_atk: 1 * 3, x_none_atk: 1 * 3 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { x_fist_atk: 2 * 3, x_none_atk: 2 * 3 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { x_fist_atk: 3 * 3, x_none_atk: 3 * 3 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { x_fist_atk: 4 * 3, x_none_atk: 4 * 3 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { x_fist_atk: 5 * 3, x_none_atk: 5 * 3 } },
        { label: 'Nv 6', value: 6, isUse: true, bonus: { x_fist_atk: 6 * 3, x_none_atk: 6 * 3 } },
        { label: 'Nv 7', value: 7, isUse: true, bonus: { x_fist_atk: 7 * 3, x_none_atk: 7 * 3 } },
        { label: 'Nv 8', value: 8, isUse: true, bonus: { x_fist_atk: 8 * 3, x_none_atk: 8 * 3 } },
        { label: 'Nv 9', value: 9, isUse: true, bonus: { x_fist_atk: 9 * 3, x_none_atk: 9 * 3 } },
        { label: 'Nv 10', value: 10, isUse: true, bonus: { x_fist_atk: 10 * 3, x_none_atk: 10 * 3 } },
      ],
    },
    {
      label: 'Dodge',
      ...
      dropdown: [
        { label: '-', value: 0, isUse: false },
        { label: 'Nv 1', value: 1, isUse: true, bonus: { flee: 1 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { flee: 3 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { flee: 4 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { flee: 6 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { flee: 7 } },
        { label: 'Nv 6', value: 6, isUse: true, bonus: { flee: 9 } },
        { label: 'Nv 7', value: 7, isUse: true, bonus: { flee: 10 } },
        { label: 'Nv 8', value: 8, isUse: true, bonus: { flee: 12 } },
        { label: 'Nv 9', value: 9, isUse: true, bonus: { flee: 13 } },
        { label: 'Nv 10', value: 10, isUse: true, bonus: { flee: 15 } },
      ],
    },
    {

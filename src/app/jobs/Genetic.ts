...
export class Genetic extends Creator {
  ...
  private readonly passiveSkillList3rd: PassiveSkillModel[] = [
    ...
    },
    {
      ...
      dropdown: [
        { label: '-', value: 0, isUse: false },
        { label: 'Nv 1', value: 1, isUse: true, bonus: { weight: 1 * 500 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { weight: 2 * 500 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { weight: 3 * 500 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { weight: 4 * 500 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { weight: 5 * 500 } },
      ],
    },
    {
      label: 'Mandragora',

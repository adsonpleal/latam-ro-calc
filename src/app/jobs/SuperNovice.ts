...
export class SuperNovice extends CharacterBase {
  ...
  protected readonly _atkSkillList: AtkSkillModel[] = [
    ...
    },
    {
      ...
      isMelee: true,
      levelList: [
        { label: 'Fatal Manace Nv7', value: 'Fatal Manace==7' },
        { label: 'Fatal Manace Nv10', value: 'Fatal Manace==10' },
      ],
      formula: (input: AtkSkillFormulaInput): number => {
    ...
    },
    {
      ...
      isMatk: true,
      levelList: [
        { label: 'Psychic Wave Nv1', value: 'Psychic Wave==1' },
        { label: 'Psychic Wave Nv2', value: 'Psychic Wave==2' },
        { label: 'Psychic Wave Nv3', value: 'Psychic Wave==3' },
        { label: 'Psychic Wave Nv4', value: 'Psychic Wave==4' },
        { label: 'Psychic Wave Nv5', value: 'Psychic Wave==5' },
      ],
      formula: (input: AtkSkillFormulaInput): number => {
        const { model, skillLevel, status } = input;
        const baseLevel = model.level;
  ...
  protected readonly _activeSkillList: ActiveSkillModel[] = [
    ...
    IntensificationFn(),
    {
      ...
      dropdown: [
        ...
        { label: 'Nv 1', value: 1, isUse: true, bonus: { agiBoost: 3, dexBoost: 3 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { agiBoost: 4, dexBoost: 4 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { agiBoost: 5, dexBoost: 5 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { agiBoost: 6, dexBoost: 6 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { agiBoost: 7, dexBoost: 7 } },
        { label: 'Nv 6', value: 6, isUse: true, bonus: { agiBoost: 8, dexBoost: 8 } },
        { label: 'Nv 7', value: 7, isUse: true, bonus: { agiBoost: 9, dexBoost: 9 } },
        { label: 'Nv 8', value: 8, isUse: true, bonus: { agiBoost: 10, dexBoost: 10 } },
        { label: 'Nv 9', value: 9, isUse: true, bonus: { agiBoost: 11, dexBoost: 11 } },
        { label: 'Nv 10', value: 10, isUse: true, bonus: { agiBoost: 12, dexBoost: 12 } },
      ],
    },
    {
      name: 'Cart Boost',
  ...
  protected readonly _passiveSkillList: PassiveSkillModel[] = [
    {
      ...
      dropdown: [
        { label: '-', value: 0, isUse: false },
        { label: 'Nv 1', value: 1, isUse: true, bonus: { atk: 15, hp: 350, sp: 30 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { atk: 30, hp: 700, sp: 60 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { atk: 45, hp: 1050, sp: 90 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { atk: 60, hp: 1400, sp: 120 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { atk: 100, hp: 2000, sp: 200 } },
      ],
    },
    {
      label: 'Transcendence',
      ...
      dropdown: [
        { label: '-', value: 0, isUse: false },
        { label: 'Nv 1', value: 1, isUse: true, bonus: { matk: 15, hp: 350, sp: 30 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { matk: 30, hp: 700, sp: 60 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { matk: 45, hp: 1050, sp: 90 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { matk: 60, hp: 1400, sp: 120 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { matk: 100, hp: 2000, sp: 200 } },
      ],
    },
    ImproveDodgeFn(),
    SnatcherFn(),
    {
      ...
      dropdown: [
        { label: '-', value: 0, isUse: false },
        { label: 'Nv 1', value: 1, isUse: true, bonus: { x_dagger_atk: 1 * 4, x_sword_atk: 1 * 4 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { x_dagger_atk: 2 * 4, x_sword_atk: 2 * 4 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { x_dagger_atk: 3 * 4, x_sword_atk: 3 * 4 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { x_dagger_atk: 4 * 4, x_sword_atk: 4 * 4 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { x_dagger_atk: 5 * 4, x_sword_atk: 5 * 4 } },
        { label: 'Nv 6', value: 6, isUse: true, bonus: { x_dagger_atk: 6 * 4, x_sword_atk: 6 * 4 } },
        { label: 'Nv 7', value: 7, isUse: true, bonus: { x_dagger_atk: 7 * 4, x_sword_atk: 7 * 4 } },
        { label: 'Nv 8', value: 8, isUse: true, bonus: { x_dagger_atk: 8 * 4, x_sword_atk: 8 * 4 } },
        { label: 'Nv 9', value: 9, isUse: true, bonus: { x_dagger_atk: 9 * 4, x_sword_atk: 9 * 4 } },
        { label: 'Nv 10', value: 10, isUse: true, bonus: { x_dagger_atk: 10 * 4, x_sword_atk: 10 * 4 } },
      ],
    },
    DemonBane,
    {
      ...
      dropdown: [
        { label: '-', value: 0, isUse: false },
        { label: 'Nv 1', value: 1, isUse: true, bonus: { dex: 1 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { dex: 2 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { dex: 3 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { dex: 4 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { dex: 5 } },
        { label: 'Nv 6', value: 6, isUse: true, bonus: { dex: 6 } },
        { label: 'Nv 7', value: 7, isUse: true, bonus: { dex: 7 } },
        { label: 'Nv 8', value: 8, isUse: true, bonus: { dex: 8 } },
        { label: 'Nv 9', value: 9, isUse: true, bonus: { dex: 9 } },
        { label: 'Nv 10', value: 10, isUse: true, bonus: { dex: 10 } },
      ],
    },
    FaithFn(),
    BeastBaneFn(),
    {
      ...
      dropdown: [
        { label: '-', value: 0, isUse: false },
        { label: 'Nv 1', value: 1, isUse: true, bonus: { x_axe_atk: 1 * 3, x_sword_atk: 1 * 3 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { x_axe_atk: 2 * 3, x_sword_atk: 2 * 3 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { x_axe_atk: 3 * 3, x_sword_atk: 3 * 3 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { x_axe_atk: 4 * 3, x_sword_atk: 4 * 3 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { x_axe_atk: 5 * 3, x_sword_atk: 5 * 3 } },
        { label: 'Nv 6', value: 6, isUse: true, bonus: { x_axe_atk: 6 * 3, x_sword_atk: 6 * 3 } },
        { label: 'Nv 7', value: 7, isUse: true, bonus: { x_axe_atk: 7 * 3, x_sword_atk: 7 * 3 } },
        { label: 'Nv 8', value: 8, isUse: true, bonus: { x_axe_atk: 8 * 3, x_sword_atk: 8 * 3 } },
        { label: 'Nv 9', value: 9, isUse: true, bonus: { x_axe_atk: 9 * 3, x_sword_atk: 9 * 3 } },
        { label: 'Nv 10', value: 10, isUse: true, bonus: { x_axe_atk: 10 * 3, x_sword_atk: 10 * 3 } },
      ],
    },
    HiltBindingFn(),
    {
      ...
      dropdown: [
        { label: '-', value: 0, isUse: false },
        { label: 'Nv 1', value: 1, skillLv: 1, isUse: true, bonus: { x_atk: 2, hit: 2 } },
        { label: 'Nv 2', value: 2, skillLv: 2, isUse: true, bonus: { x_atk: 4, hit: 4 } },
        { label: 'Nv 3', value: 3, skillLv: 3, isUse: true, bonus: { x_atk: 6, hit: 6 } },
        { label: 'Nv 4', value: 4, skillLv: 4, isUse: true, bonus: { x_atk: 8, hit: 8 } },
        { label: 'Nv 5', value: 5, skillLv: 5, isUse: true, bonus: { x_atk: 10, hit: 10 } },
        { label: 'Nv 6', value: 6, skillLv: 6, isUse: true, bonus: { x_atk: 12, hit: 12 } },
        { label: 'Nv 7', value: 7, skillLv: 7, isUse: true, bonus: { x_atk: 14, hit: 14 } },
        { label: 'Nv 8', value: 8, skillLv: 8, isUse: true, bonus: { x_atk: 16, hit: 16 } },
        { label: 'Nv 9', value: 9, skillLv: 9, isUse: true, bonus: { x_atk: 18, hit: 18 } },
        { label: 'Nv 10', value: 10, skillLv: 10, isUse: true, bonus: { x_atk: 20, hit: 20 } },
      ],
    },

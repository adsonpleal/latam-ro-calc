  ...
  protected readonly passiveSkillList3rd: PassiveSkillModel[] = [
    {
      ...
      dropdown: [
        ...
        { label: 'Nv 1', value: 1, isUse: true, bonus: { atk_Mace: 3, cri: 1 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { atk_Mace: 6, cri: 2 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { atk_Mace: 9, cri: 3 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { atk_Mace: 12, cri: 4 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { atk_Mace: 15, cri: 5 } },
        { label: 'Nv 6', value: 6, isUse: true, bonus: { atk_Mace: 18, cri: 6 } },
        { label: 'Nv 7', value: 7, isUse: true, bonus: { atk_Mace: 21, cri: 7 } },
        { label: 'Nv 8', value: 8, isUse: true, bonus: { atk_Mace: 24, cri: 8 } },
        { label: 'Nv 9', value: 9, isUse: true, bonus: { atk_Mace: 27, cri: 9 } },
        { label: 'Nv 10', value: 10, isUse: true, bonus: { atk_Mace: 30, cri: 10 } },
      ],
    },
    {
      inputType: 'dropdown',
      ...
      dropdown: [
        { label: '-', value: 0, isUse: false },
        { label: 'Nv 1', value: 1, isUse: true, bonus: { spPercent: 1 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { spPercent: 2 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { spPercent: 3 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { spPercent: 4 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { spPercent: 5 } },
        { label: 'Nv 6', value: 6, isUse: true, bonus: { spPercent: 6 } },
        { label: 'Nv 7', value: 7, isUse: true, bonus: { spPercent: 7 } },
        { label: 'Nv 8', value: 8, isUse: true, bonus: { spPercent: 8 } },
        { label: 'Nv 9', value: 9, isUse: true, bonus: { spPercent: 9 } },
        { label: 'Nv 10', value: 10, isUse: true, bonus: { spPercent: 10 } },
      ],
    },
    {
      inputType: 'dropdown',

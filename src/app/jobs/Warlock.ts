...
export class Warlock extends HighWizard {
  ...
  private readonly activeSkillList3rd: ActiveSkillModel[] = [
    {
      ...
      dropdown: [
        { label: 'Sim', isUse: true, value: 1, bonus: { spell_maximize: 1 } },
    ...
    IntensificationFn(),
    {
      ...
      inputType: 'selectButton',
      dropdown: [
        { label: 'Sim', isUse: true, value: 1, bonus: { releasedSkill: 1 } },
        { label: 'Não', isUse: false, value: 0 },
      ],
    },
  ];
  protected readonly passiveSkillList3rd: PassiveSkillModel[] = [
    ...
    },
    {
      ...
      dropdown: [
        { label: '-', isUse: false, value: 0 },
        { label: 'Nv 1', isUse: true, value: 1, bonus: { fctPercent: 10 * 1 } },
        { label: 'Nv 2', isUse: true, value: 2, bonus: { fctPercent: 10 * 2 } },
        { label: 'Nv 3', isUse: true, value: 3, bonus: { fctPercent: 10 * 3 } },
      ],
    },
    {
      inputType: 'dropdown',

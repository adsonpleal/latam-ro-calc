  ...
  private passiveSkillListHi: PassiveSkillModel[] = [
    BeastBaneFn(),
    {
      ...
      dropdown: [
        ...
        { label: 'Nv 1', value: 1, isUse: true, bonus: { falconDmg: 6 } },
        { label: 'Nv 2', value: 2, isUse: true, bonus: { falconDmg: 12 } },
        { label: 'Nv 3', value: 3, isUse: true, bonus: { falconDmg: 18 } },
        { label: 'Nv 4', value: 4, isUse: true, bonus: { falconDmg: 24 } },
        { label: 'Nv 5', value: 5, isUse: true, bonus: { falconDmg: 30 } },
        { label: 'Nv 6', value: 6, isUse: true, bonus: { falconDmg: 36 } },
        { label: 'Nv 7', value: 7, isUse: true, bonus: { falconDmg: 42 } },

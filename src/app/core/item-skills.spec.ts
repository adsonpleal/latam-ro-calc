 ...
 * Empty today. 6001 (Dragonic Breath) sat here from 17/08/2026, when the skill left the
 * catalog, until 14/09/2026, when it came back as a preview — its 20 item lines (630027
 * Tridente Celestial, 400374 the Crown of Good and Evil and 312449 Good Vigor among them)
 * are read again now that the skill can be picked.
 *
 ...
 */
const NOT_IN_LATAM_SKILL_IDS = new Set<number>([]);

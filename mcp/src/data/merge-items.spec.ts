...
describe('mergeLatamItems', () => {
  ...
  it('flags exactly the LATAM intersection', () => {
    // Regression guard on the overlay: 6682 of item.json's 9562 records exist in the
    ...
    expect(flagged).toBe(6682);
    expect(Object.keys(items)).toHaveLength(9562);
  });

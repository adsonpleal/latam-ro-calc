...
describe('mergeLatamItems', () => {
  ...
  it('flags exactly the LATAM intersection', () => {
    // Regression guard on the overlay: 6860 of item.json's 9740 records exist in the
    ...
    expect(flagged).toBe(6860);
    expect(Object.keys(items)).toHaveLength(9740);
  });

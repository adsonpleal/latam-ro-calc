...
describe('mergeLatamItems', () => {
  ...
  it('flags exactly the LATAM intersection, plus the preRelease opt-ins', () => {
    // Regression guard on the overlay: 7177 of item.json's 10469 records exist in the
    ...
    expect(flagged).toBe(7334);
    expect(Object.keys(items)).toHaveLength(10469);
  });

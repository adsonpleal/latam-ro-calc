...
describe('mergeLatamItems', () => {
  ...
  it('flags exactly the LATAM intersection', () => {
    // Regression guard on the overlay: 6470 of item.json's 9762 records exist in the
    ...
    expect(flagged).toBe(6470);
    expect(Object.keys(items)).toHaveLength(9762);
  });

...
describe('mergeLatamItems', () => {
  ...
  it('flags exactly the LATAM intersection', () => {
    // Regression guard on the overlay: 6824 of item.json's 9704 records exist in the
    ...
    expect(flagged).toBe(6824);
    expect(Object.keys(items)).toHaveLength(9704);
  });

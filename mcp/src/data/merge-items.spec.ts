...
describe('mergeLatamItems', () => {
  ...
  it('flags exactly the LATAM intersection', () => {
    // Regression guard on the overlay: 6687 of item.json's 9567 records exist in the
    ...
    expect(flagged).toBe(6687);
    expect(Object.keys(items)).toHaveLength(9567);
  });

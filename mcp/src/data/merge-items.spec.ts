...
describe('mergeLatamItems', () => {
  ...
  it('flags exactly the LATAM intersection, plus the preRelease opt-ins', () => {
    // Regression guard on the overlay: 7176 of item.json's 10468 records exist in the
    ...
    expect(flagged).toBe(7333);
    expect(Object.keys(items)).toHaveLength(10468);
  });

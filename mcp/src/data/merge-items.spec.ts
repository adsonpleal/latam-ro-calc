...
describe('mergeLatamItems', () => {
  ...
  it('flags exactly the LATAM intersection', () => {
    // Regression guard on the overlay: 6859 of item.json's 9739 records exist in the
    ...
    expect(flagged).toBe(6859);
    expect(Object.keys(items)).toHaveLength(9739);
  });

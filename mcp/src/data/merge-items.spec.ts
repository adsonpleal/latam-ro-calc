...
describe('mergeLatamItems', () => {
  ...
  it('flags exactly the LATAM intersection', () => {
    // Regression guard on the overlay: 6619 of item.json's 9545 records exist in the
    ...
    expect(flagged).toBe(6619);
    expect(Object.keys(items)).toHaveLength(9545);
  });

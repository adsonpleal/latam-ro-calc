...
describe('mergeLatamItems', () => {
  ...
  it('flags exactly the LATAM intersection', () => {
    // Regression guard on the overlay: 6727 of item.json's 10019 records exist in the
    ...
    expect(flagged).toBe(6727);
    expect(Object.keys(items)).toHaveLength(10019);
  });

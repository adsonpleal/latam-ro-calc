...
describe('mergeLatamItems', () => {
  ...
  it('flags exactly the LATAM intersection, plus the preRelease opt-ins', () => {
    // Regression guard on the overlay: 7268 of item.json's 10505 records exist in the
    ...
    expect(flagged).toBe(7398);
    expect(Object.keys(items)).toHaveLength(10505);
  });

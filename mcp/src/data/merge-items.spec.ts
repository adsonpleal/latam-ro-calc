...
describe('mergeLatamItems', () => {
  ...
  it('flags exactly the LATAM intersection, plus the preRelease opt-ins', () => {
    // Regression guard on the overlay: 7165 of item.json's 10457 records exist in the
    ...
    expect(flagged).toBe(7322);
    expect(Object.keys(items)).toHaveLength(10457);
  });
